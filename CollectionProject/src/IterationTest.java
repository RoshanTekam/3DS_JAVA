...
class EventAgency {
	public static Magician getMagician(String hint) {
		...
		else if(hint.equalsIgnoreCase("manipulate"))
			magician =new ManipulateMagician();
		return magician;
	}
}
...
class ManipulateMagician implements Magician
{
	@Override
	public Magic doTrick(Account acc) {
		System.out.println("Manipulate things...");
		Magic magic=new ManipulateMagic();
		return magic;
	}
}
...
class ManipulateMagic implements Magic
{
	public void show()
	{
		System.out.println("Showing manipulata cards and puzzles....");
	}
}
