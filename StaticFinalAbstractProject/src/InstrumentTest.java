...
public class InstrumentTest {
	public static void main(String[] args) {
		...
		/*
		 * Guitar guitar = new Guitar(); guitar.use(); guitar.tuneStrings();
		 * guitar.play(); guitar.pluck();
		 * 
		 * Violin violin = new Violin(); violin.use(); violin.tuneStrings();
		 * violin.play(); violin.bow();
		 */
